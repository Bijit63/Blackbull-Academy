...
const Navbar = () => {
  ...
  return (
    <nav id="navbar" className="bg-[#070718] flex flex-col items-center md:px-6 px-3 md:py-3 py-2 rounded-sm">
      <div className="flex w-full justify-between items-center">
        ...
        <button className="block md:hidden text-white text-2xl" onClick={handleToggle}>
          {isCollapsed ? "×" : "☰"}
        </button>
        ...
        <div className="roboto hidden md:block">
          <ul className="flex text-gray-100 text-lg">
            <li className="mr-6">
              <Link to="/" className="hover:border-b-2 py-1 border-[#576CBC] duration-150 ease-in-out">
                Features
              </Link>
            </li>
            <li className="mr-6">
